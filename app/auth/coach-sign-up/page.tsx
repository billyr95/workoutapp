  ...
  return (
    <div className="max-w-xl mx-auto min-h-screen flex flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="card !border-[var(--coach-blue-dim)]">
          <div className="mb-3">
            <input placeholder="Invite code" value={code} onChange={(e) => setCode(e.target.value.trim())} required />
          </div>
          <div className="mb-3">
          ...
          <button type="submit" className="btn w-full !bg-[var(--coach-blue)] !text-white" disabled={loading || !agreed}>
