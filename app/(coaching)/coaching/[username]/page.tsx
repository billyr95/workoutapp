                    ...
                    <div className="mt-3 pt-3 border-t border-[var(--coach-blue-dim)]">
                      ...
                      {editingWorkout.exercises.map((ex) =>
                        editingExerciseId === ex.id ? (
                          <div key={ex.id} className="mb-2.5 p-2.5 rounded border border-[var(--coach-blue-dim)]">
                            <input
                            ...
                            <div className="flex gap-2">
                              <button
                                className="btn !bg-[var(--coach-blue)] !text-white !py-1.5 !px-3 !text-[11px]"
                          ...
                          <div key={ex.id} className="flex items-center gap-2 mb-1.5">
                            ...
                            <span
                              className="font-label text-xs text-[var(--muted)] hover:text-[var(--coach-blue)] underline cursor-pointer shrink-0"
